...
TOOLHIVE_OPERATOR_CRDS_CHART_VERSION="0.12.4" # renovate: datasource=docker depName=ghcr.io/stacklok/toolhive/toolhive-operator-crds
TOOLHIVE_OPERATOR_CHART_VERSION="0.12.4" # renovate: datasource=docker depName=ghcr.io/stacklok/toolhive/toolhive-operator
