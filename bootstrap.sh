...
TOOLHIVE_OPERATOR_CRDS_CHART_VERSION="0.9.4" # renovate: datasource=docker depName=ghcr.io/stacklok/toolhive/toolhive-operator-crds
TOOLHIVE_OPERATOR_CHART_VERSION="0.9.4" # renovate: datasource=docker depName=ghcr.io/stacklok/toolhive/toolhive-operator
REGISTRY_SERVER_CHART_VERSION="0.6.2" # renovate: datasource=docker depName=ghcr.io/stacklok/toolhive-registry-server
CLOUD_UI_VERSION="v0.3.0" # renovate: datasource=docker depName=ghcr.io/stacklok/toolhive-cloud-ui
