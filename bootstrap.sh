...
TRAEFIK_CHART_VERSION="39.0.8" # renovate: datasource=helm depName=traefik registryUrl=https://traefik.github.io/charts
...
TOOLHIVE_OPERATOR_CRDS_CHART_VERSION="0.23.1" # renovate: datasource=docker depName=ghcr.io/stacklok/toolhive/toolhive-operator-crds
TOOLHIVE_OPERATOR_CHART_VERSION="0.23.1" # renovate: datasource=docker depName=ghcr.io/stacklok/toolhive/toolhive-operator
REGISTRY_SERVER_CHART_VERSION="1.2.2" # renovate: datasource=docker depName=ghcr.io/stacklok/toolhive-registry-server
