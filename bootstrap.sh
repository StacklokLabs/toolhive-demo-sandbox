...
TOOLHIVE_OPERATOR_CRDS_CHART_VERSION="0.27.1" # renovate: datasource=docker depName=ghcr.io/stacklok/toolhive/toolhive-operator-crds
TOOLHIVE_OPERATOR_CHART_VERSION="0.27.1" # renovate: datasource=docker depName=ghcr.io/stacklok/toolhive/toolhive-operator
REGISTRY_SERVER_VERSION="v1.4.2" # renovate: datasource=docker depName=ghcr.io/stacklok/thv-registry-api
