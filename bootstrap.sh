...
TRAEFIK_CHART_VERSION="39.0.6" # renovate: datasource=helm depName=traefik registryUrl=https://traefik.github.io/charts
CERT_MANAGER_CHART_VERSION="v1.20.0" # renovate: datasource=docker depName=quay.io/jetstack/charts/cert-manager versioning=semver
...
PROMETHEUS_CHART_VERSION="28.14.0" # renovate: datasource=helm depName=prometheus registryUrl=https://prometheus-community.github.io/helm-charts
GRAFANA_CHART_VERSION="11.3.4" # renovate: datasource=helm depName=grafana registryUrl=https://grafana-community.github.io/helm-charts
...
TOOLHIVE_OPERATOR_CRDS_CHART_VERSION="0.13.0" # renovate: datasource=docker depName=ghcr.io/stacklok/toolhive/toolhive-operator-crds
TOOLHIVE_OPERATOR_CHART_VERSION="0.13.0" # renovate: datasource=docker depName=ghcr.io/stacklok/toolhive/toolhive-operator
REGISTRY_SERVER_CHART_VERSION="0.6.6" # renovate: datasource=docker depName=ghcr.io/stacklok/toolhive-registry-server
CLOUD_UI_VERSION="v0.4.3" # renovate: datasource=docker depName=ghcr.io/stacklok/toolhive-cloud-ui
