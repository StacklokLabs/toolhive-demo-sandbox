...
TEMPO_CHART_VERSION="1.26.6" # renovate: datasource=helm depName=tempo registryUrl=https://grafana-community.github.io/helm-charts
...
GRAFANA_CHART_VERSION="11.2.2" # renovate: datasource=helm depName=grafana registryUrl=https://grafana-community.github.io/helm-charts
...
TOOLHIVE_OPERATOR_CRDS_CHART_VERSION="0.11.0" # renovate: datasource=docker depName=ghcr.io/stacklok/toolhive/toolhive-operator-crds
TOOLHIVE_OPERATOR_CHART_VERSION="0.11.0" # renovate: datasource=docker depName=ghcr.io/stacklok/toolhive/toolhive-operator
REGISTRY_SERVER_CHART_VERSION="0.6.2" # renovate: datasource=docker depName=ghcr.io/stacklok/toolhive-registry-server
CLOUD_UI_VERSION="v0.3.2" # renovate: datasource=docker depName=ghcr.io/stacklok/toolhive-cloud-ui
