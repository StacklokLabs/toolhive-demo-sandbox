...
REGISTRY_API_VERSION="v0.6.2" # renovate: datasource=docker depName=ghcr.io/stacklok/thv-registry-api
CLOUD_UI_VERSION="v0.2.0" # renovate: datasource=docker depName=ghcr.io/stacklok/toolhive-cloud-ui
